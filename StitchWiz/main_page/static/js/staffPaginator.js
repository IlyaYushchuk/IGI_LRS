...
const staffList = document.getElementById('employee-list').querySelector('tbody');
...
function renderEmployees()
{
    ...
    employeesToShow.forEach(employee => {
        ...
        {
            employee.image = '/static/deps/images/staff-base-avatar.jpg';
        }
...
bonusButton.addEventListener('click', async function() {
    ...
    p.textContent = "Премией награждаются сотрудники:";
    bonusInfo.appendChild(p);
    let info;
    checkedEmployees.forEach(employee => {
        info = document.createElement('p');
        info.textContent = `${employee.last_name} ` + `${employee.first_name} `;
...
function checkForm()
{
    ...
    if (isURLValid && isPhoneValid && last_nameValid && first_nameValid && jobDescriptionValid && emailValid)
    {
